...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 61.0, 226.0, 154.0 ],
					"style" : "",
					"text" : "round data to the nearest integer.\nthis function expects a list of one or more elements of floats.\n\nif a number is between 0 and 0.49999 of a whole number, the resultant number is rounded down, ortherwise rounded up.\n\narguments:\n\n1. data to round"
				}
