...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Basic utility for playing sound files with 0-1 phase lookup, designed to work with m158.o.buffer~.\n\n/buffer/name sets buffer to play.\n\n/buffer/selected/start and /buffer/selected/end are used to scale the incoming phase to that region of the file."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 621.0, 43.0, 196.0, 27.0 ],
					"style" : "",
					"text" : "m158.o.buffer.player~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 309.0, 407.0, 94.0, 22.0 ],
					"style" : "",
					"text" : "m158.o.phase~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 309.0, 370.0, 189.0, 22.0 ],
					"style" : "",
