...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "in this example, m158.o.norm.scale~ is used to play a region of the total phase duration, at the correct speed."
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "m158.o.norm.scale~ /playpoints"
				}
