...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "in this example, cnmat.o.phase.scale~ is used to play a region of the total phase duration, at the correct speed."
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "cnmat.o.phase.scale~ /playpoints"
				}
