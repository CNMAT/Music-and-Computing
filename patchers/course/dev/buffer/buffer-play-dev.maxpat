...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 312.0, 267.0, 155.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 312.0, 227.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "o.union"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 689.0, 473.0, 221.0, 238.0 ],
					"presentation_rect" : [ 563.0, 466.0, 0.0, 0.0 ],
					"text" : "/buffer/trigger : 1,\n/buffer/selected/start : 0.,\n/buffer/selected/end : 0.0611354,\n/buffer/hopsize : 256,\n/buffer/fftsize : 1024,\n/buffer/buffername : \"1101-buffer\",\n/buffer/nsamples : 153400,\n/buffer/ms : 3478.46,\n/buffer/samplerate : 44100.,\n/buffer/selected/length : 0.0611354,\n/buffer/selected/ms : 212.657,\n/ms : 280.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 71.0, 513.0, 130.0, 130.0 ],
					"presentation_rect" : [ 71.0, 513.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 312.0, 377.0, 94.0, 22.0 ],
					"presentation_rect" : [ 306.0, 316.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "m158.o.phase~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.5, 83.0, 85.0, 22.0 ],
					"presentation_rect" : [ 682.0, 222.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 645.5, 121.0, 50.0, 22.0 ],
					"presentation_rect" : [ 682.0, 260.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 645.5, 155.0, 69.0, 22.0 ],
					"presentation_rect" : [ 682.0, 294.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "o.pack /ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1009.0, 556.0, 100.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1244.0, 469.0, 329.0, 37.0 ],
					"style" : "",
					"text" : "This m158.phase.click~ creates a sample tick based on the divided phase."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1227.0, 312.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1124.0, 473.0, 110.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 925.0, 155.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1227.0, 355.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1124.0, 394.0, 122.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 925.0, 193.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 925.0, 227.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 925.0, 390.0, 110.0, 22.0 ],
					"style" : "",
					"text" : "m158.phase.click~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "signal", "" ],
					"patching_rect" : [ 925.0, 260.0, 94.0, 22.0 ],
					"style" : "",
					"text" : "m158.o.phase~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 312.0, 321.5, 155.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 227.0, 221.0, 211.0 ],
					"text" : "/buffer/trigger : 1,\n/buffer/selected/start : 0.,\n/buffer/selected/end : 0.0611354,\n/buffer/hopsize : 256,\n/buffer/fftsize : 1024,\n/buffer/buffername : \"1101-buffer\",\n/buffer/nsamples : 153400,\n/buffer/ms : 3478.46,\n/buffer/samplerate : 44100.,\n/buffer/selected/length : 0.0611354,\n/buffer/selected/ms : 212.657",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
