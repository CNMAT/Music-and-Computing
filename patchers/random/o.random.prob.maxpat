...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 299.0, 619.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "o.select /prob"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 299.0, 515.0, 590.0, 86.0 ],
					"text" : "map(\n  lambda(a,\n    assign(\"/prob/result\"+a, map( lambda(t, int32(/~/rand() < t) ), value(a)) )\n  ), /addrs\n)",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.5, 93.5, 282.0, 51.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 372.5, 662.0, 880.5, 662.0, 880.5, 419.0, 339.5, 419.0 ],
					"source" : [ "obj-36", 1 ]
				}
