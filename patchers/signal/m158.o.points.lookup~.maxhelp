...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 493.0, 130.0, 130.0 ],
					"presentation_rect" : [ 405.0, 459.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 347.0, 130.0, 130.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 652.0, 687.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 320.0, 285.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "phasor~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 669.5, 236.0, 141.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.0, 122.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 343.0, 130.0, 200.0, 100.0 ],
					"style" : "",
					"varname" : "function[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.5, 58.5, 142.0, 22.0 ],
					"style" : "",
					"text_width" : 66.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 669.5, 146.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 669.5, 183.5, 70.0, 22.0 ],
					"style" : "",
					"text" : "m158.o.gui"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 748.0, 170.0, 97.0, 49.0 ],
					"saved_object_attributes" : 					{
